          ...
          {searchOpen ? (
            <form onSubmit={handleSearch} className="flex items-center gap-2">
              <input
                ...
                placeholder="Product dhoondo..."
                className="border border-green-300 rounded-full px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 w-32 md:w-48"
              />
              <button
                type="button"
