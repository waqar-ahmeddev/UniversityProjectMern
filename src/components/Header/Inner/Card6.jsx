...
const Card = (props) => {
  return (
    ...
    <div className="w-48 bg-white border border-gray-100 rounded-3xl p-5 flex flex-col items-center justify-center shadow-[0_10px_25px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.08)] transition-all duration-300 ease-in-out cursor-pointer group">
      
      {/* Image Container: Object-contain lagaya hai taaki sabzian bikhrein nahi */}
      <div className="w-32 h-32 flex items-center justify-center overflow-hidden mb-4 group-hover:scale-105 transition-transform duration-300">
        <img 
